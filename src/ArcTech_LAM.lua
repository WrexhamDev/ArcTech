...
function BuildOptions()
    ...
    opts[#opts + 1] = { type = "header", name = ColorText("active", "Guild Members: " .. tostring(memberCount or 0)) }
    opts[#opts + 1] = { type = "header", name = ColorText("active", "Your Points: 0 (Not Implemented Yet)") }
