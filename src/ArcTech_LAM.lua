...
function BuildOptions()
    ...
    opts[#opts + 1] = { type = "button", name = ColorText("disabled", "Your Points: 0 (Not Implemented Yet)"), disabled = true }
    opts[#opts + 1] = { type = "button", name = ColorText("disabled", "Your Raffle Tickets: 0/50 (Not Implemented Yet)"), disabled = true }
